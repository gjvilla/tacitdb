...
- **[GOLDEN.md](GOLDEN.md)** — the golden suite, which now audits itself
  (2026-08-24, D-0028): a question resting on a review trigger that has already
  fired turns the suite red, because four of them had fired unnoticed and one
  was passing on two errors cancelling. `cargo run -p tacit-keeper --example
